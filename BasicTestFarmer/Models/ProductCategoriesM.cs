...
namespace BasicTestFarmer.Models
{
    ...
    public partial class ProductCategoriesM
    {
        ...
        public ProductCategoriesM()
        {
            this.SubProductCategories = new HashSet<SubProductCategories>();
        }
    
        public int ProductCategoriesMID { get; set; }
        public string ProductCategoriesMName { get; set; }
        public Nullable<int> ProductCategoriesID { get; set; }
        public string CProductCategoriesMName { get; set; }
